...
# Check that all dependencies are installed for this script to run correctly
...
# The Postgres container might not be ready to
# accept connections when we try to run sqlx database create
# Keep pinging Postgress until it's ready to accept commands
...
# Export database url to an env variable
